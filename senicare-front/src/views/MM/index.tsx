...
export default function MM() {
  ...
  const onSearchWordCheangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
      const { value } = event.target;
      setSearchWord(value);
  };
  ...
  useEffect(() => {
    ...
    // totalcount 에 totallist 길이를 담고 상태변경시 동작하도록 해주는 코드
  ...
  return (
    ...
    <div className='bottom'>
      ...
      <div className='search-box'>
        <input className='search-input' value={searchWord} placeholder='검색어를 입력하세요.'   onChange={onSearchWordCheangeHandler}/>
