...
import { fileUploadRequest, postCustomerRequest, getNurseListRequest, getCustomerRequest, patchCustomerRequest } from 'src/apis';
...
import { CS_ABSOLUTE_PATH, ACCESS_TOKEN, CS_DETAIL_ABSOLUTE_PATH } from 'src/constants';
