      ...
      <div className='main'>
        ...
        <div className='input-container'>
          <div className='input-box'>
            ...
            <input className='input' value={name} placeholder='고객 이름을 선택하세요.' onChange={onNameChangeHandler} />
          </div>
          <div className='input-box'>
          ...
          <div className='input-box'>
            ...
            <div className='button-box'>
              ...
              <div className='button disable' onClick={onModalOpenHandler} onKeyDown={onSearchWordKeydownHandler}>검색</div>
            </div>
          </div>
          <div className='input-box'>
            <div className='input-label'>주소</div>
            <input className='input' value={address} placeholder='주소를 입력하세요.' />
            <div className='button-box'>
          ...
          <div className='modal-box'>
            ...
            <div className='modal-main'>
              <div className='table'>
                ...
                {/*viewList를 사용하여 map으로 nurse 정보들을 뿌려준다.*/}
              ...
              <div className='modal-pagenation-box'>
