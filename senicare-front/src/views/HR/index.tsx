...
function TableRow({nurse}: TableRowProps) {
    ...
    const onRowClickHandler = (event:MouseEvent<HTMLDivElement>) => {
...
export default function HR() {
  ...
  const getNurseListResponse = (responseBody: GetNurseListResponseDto | ResponseDto |null) => {
      ...
      // nurses 객체를 가져와서 각각의 상태변화에 값이 변하도록 해준다
  ...
  // event handler: 검색 버튼 엔터 클릭 이벤트 처리 //
    ...
    <div id='hr-wrapper'>
        ...
        <div className='bottom'>
          ...
          <div className='search-box'>
              <input className='search-input' value={searchWord} placeholder='검색어를 입력해주세요.' onChange={onSearchWordChangeHandler} onKeyDown={onkeyDownHandler}/>
