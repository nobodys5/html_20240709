...
import { ACCESS_TOKEN, AUTH_ABSOLUTE_PATH, AUTH_PATH, CS_DETAIL_PATH, CS_PATH, CS_UPDATE_PATH, CS_WRITE_PATH, HR_DETAIL_PATH, HR_PATH, HR_UPDATE_PATH, MM_PATH, OTHER_PATH } from './constants';
...
function Index() {
  ...
  useEffect(() => {
    if (cookies[ACCESS_TOKEN]) navigator('/cs');
